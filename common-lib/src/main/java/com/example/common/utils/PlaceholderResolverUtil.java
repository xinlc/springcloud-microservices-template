...
public class PlaceholderResolverUtil {
	 ...
	 * 默认单例解析器
	 */
	private static PlaceholderResolverUtil defaultResolver = new PlaceholderResolverUtil();
	...
	private PlaceholderResolverUtil(String placeholderPrefix, String placeholderSuffix) {
	 ...
	 * @return
	 */
	public static PlaceholderResolverUtil getDefaultResolver() {
		return defaultResolver;
	}

	public static PlaceholderResolverUtil getResolver(String placeholderPrefix, String placeholderSuffix) {
		return new PlaceholderResolverUtil(placeholderPrefix, placeholderSuffix);
	}
